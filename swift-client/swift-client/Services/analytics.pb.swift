...
struct Analytics_AnalyticsEvent: Sendable {
...
extension Analytics_AnalyticsEvent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".AnalyticsEvent"
  ...
  static func ==(lhs: Analytics_AnalyticsEvent, rhs: Analytics_AnalyticsEvent) -> Bool {
